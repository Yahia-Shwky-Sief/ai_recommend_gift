...
void main() async {
  ...
  runApp(MyApp(initialTheme: isDark ? ThemeMode.dark : ThemeMode.light, themeService: themeService));
}

class MyApp extends StatelessWidget {
  final ThemeMode initialTheme;
  final ThemeService themeService;
  const MyApp({super.key, required this.initialTheme, required this.themeService});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => ThemeCubit(themeService)..emit(initialTheme),
